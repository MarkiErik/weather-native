...
export function WeatherCard({ icon, city, temperature, description, high, low }: WeatherCardProps) {
  return (
    <View className="items-center">
      <Text className="text-7xl">{icon}</Text>
      <Text className="mt-2 text-2xl font-semibold text-white">{city}</Text>
      <Text className="text-[96px] font-thin leading-none text-white">{temperature}°</Text>
